...
var tempreture = -5;
var suggest = "it's cold outside wear warm cloth.";
var suggest1 = "it's a harsh weather outside read cautions before before going outside.";
var suggest2 = "warm weather today, enjoy the day at beach. ";
var suggest3 = "today is hot wear light cloths and drink plenty of water.";
...
var givenNumber = 113;
var output = `${givenNumber} is divisible by 3.`;
var output1 = `${givenNumber} is not divisible by 3.`;
var output2 = `${givenNumber} is divisible by 5."`;
var output3 = `${givenNumber} is not divisible by 5.`;
var output4 = `${givenNumber} is divisible by both 3 & 5.`;
var output5 = `${givenNumber} is not divisible by both 3 & 5.`;
{
    if (givenNumber % 3 == 0) {
        console.log(output);
    }
...
var givenYear = 2023;
var answer = `${givenYear} is leap year.`;
var answer1 = `${givenYear} is not leap year.`;
